/*
    DSM-cc-addressable.js
    - DVBSTP 의 Schedule 정보 parsing 을 위해 DSM-cc-addressable-section 을 분석해 줌.
*/
...
var addressable_file_changed = (imgsrc) => {    /* when ThumbNail file upload succed. */
    let loadingfiles = document.getElementById("dsm-cc-addressable_file_in");  //.dataTransfer.files;
...
window.onload = function main() {
    ...
    let text_area = document.getElementById("dsm-cc-addressable");
...
var cri_header_parse = (blob) => {
    ...
    for (var i=0; i<val_num_cri_struct; i++) {
        ...
        ul_tag.innerHTML = ul_tag.innerHTML 
                + "<li>type: 0x"+type.toString(16).toUpperCase() 
